...
declare type RedisClientMultiCommandType = ReturnType<typeof redisClient.multi>;
declare type RedisClientType = ReturnType<typeof createClient>;
declare class RedisContext implements Context {
    client: RedisClientType;
    txn: RedisClientMultiCommandType | undefined;
    contextId: string;
    ...
    addFunctionTask(txnMngr: MultiTxnMngr, execFunc: (client: RedisClientType, txn: RedisClientMultiCommandType, task: Task) => RedisClientMultiCommandType): void;
}
declare class RedisTask implements Task {
    context: RedisContext;
    rs: any | undefined;
    execFunc: (client: RedisClientType, txn: RedisClientMultiCommandType, task: Task) => RedisClientMultiCommandType;
    constructor(context: RedisContext, execFunc: (client: RedisClientType, txn: RedisClientMultiCommandType, task: Task) => RedisClientMultiCommandType);
